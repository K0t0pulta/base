document.addEventListener('DOMContentLoaded', () => {
	...
	document.querySelector('.x-btn').addEventListener('click', () => {
		...
		document.querySelector('.container').style.cssText = 'background: linear-gradient(rgba(0,0,0, .8), rgba(0,0,0, .7)), url(https://wallpaperboat.com/wp-content/uploads/2019/11/ocean-sunset-23.jpg) center no-repeat; background-size: cover';
	})
})
